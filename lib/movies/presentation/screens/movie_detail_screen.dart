...
import 'package:movies/core/components/components.dart';
import '../controller/movie_detail/movie_detail_event.dart';
import '../controller/movie_detail/movie_detail_state.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: WillPopScope(
        onWillPop: () async {
          final queue = MoviesDetailQueue().popMovieId(id);
          if (queue == null) {
            navigatorPushReplacement(context, const MoviesScreen());
          } else {
            navigatorPushReplacement(context, MovieDetailScreen(id: queue));
          }
          return true;
        },
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
      buildWhen: (previous, current) =>
          current.movieDetailRequestState != previous.movieDetailRequestState,
        ...
        return SliverGrid(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return InkWell(
                onTap: () {
                  MoviesDetailQueue().pushMovieId(recommendation.id);
